...
- (void)viewDidLoad {
    ...
    self.btn1 = [[UIButton alloc] initWithFrame:CGRectMake((MM/2)-80,(HH/2-15)-120-5,160,30)];
    self.btn2 = [[UIButton alloc] initWithFrame:CGRectMake((MM/2)-80,(HH/2-15)-10,160,30)];
    self.btn3 = [[UIButton alloc] initWithFrame:CGRectMake((MM/2)-80,(HH/2-15)+121-6,160,30)];
